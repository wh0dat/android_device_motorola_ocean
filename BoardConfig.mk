...
SDCLANG := true
SDCLANG_PATH := $(TOP)/prebuilts/clang/host/linux-x86/sdclang-6.0.2/bin
SDCLANG_PATH_2 := $(TOP)/prebuilts/clang/host/linux-x86/sdclang-6.0.2/bin
SDCLANG_LTO_DEFS := $(TOP)/device/motorola/ocean/sdllvm-lto-defs.mk
